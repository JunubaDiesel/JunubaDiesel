...
export const ui = {
  ...
  catalogBanner:
    "Consulte diagramas y números OEM. Luego verifique stock en JUNUBA.",
  noOemCode: "¿No encuentra el código?",
  verDiagramaOem: "Ver diagrama OEM",
  ...
  catalogOem: "Diagrama OEM",
  catalogOemDesc:
    "Seleccione vehículo y categoría para consultar diagramas y códigos OEM en Partsouq. Luego verifique stock en JUNUBA.",
  selectVehicle: "Seleccionar vehículo",
  selectVariant: "Seleccionar variante",
  selectCategory: "Categoría OEM",
  reviewList: "Lista de revisión",
  addToReview: "Añadir a lista",
  openPartsouq: "Abrir en Partsouq",
  copyLink: "Copiar enlace",
  searchOemNumber: "Buscar código OEM",
  searchOemPlaceholder: "Ej: 391002A000",
  requestQuoteFromList: "Solicitar cotización con lista",
  copyList: "Copiar lista",
  clearList: "Vaciar lista",
  emptyReviewList: "No hay piezas en la lista de revisión.",
  emptyReviewHint: "Añada códigos OEM desde Partsouq o búsqueda manual.",
  iframeBlocked: "El catálogo no se puede mostrar aquí. Abra Partsouq en una nueva pestaña.",
